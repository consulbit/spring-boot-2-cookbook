...
public class Isbn {
  ...
  public Isbn(String eanPrefix, String registrationGroup, String registrant,
      String publication, String checkDigit) {
  ...
  public static Isbn parseFrom(String isbn) {
    ...
    Assert.state(parts.length == 5, "The isbn is malformed.");
    Assert.noNullElements(parts, "The split isbn must not contains null value");
